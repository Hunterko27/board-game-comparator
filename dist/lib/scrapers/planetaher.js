...
exports.PlanetaHerScraper = void 0;
const puppeteer_1 = __importDefault(require("puppeteer"));
class PlanetaHerScraper {
    constructor() {
        this.name = 'Planeta Her';
    }
    async search(query) {
        ...
        try {
            ...
            const products = await page.evaluate((query) => {
                ...
                productElements.forEach((el) => {
                    ...
                    const imageElement = el.querySelector('.product-box__image');
...
exports.PlanetaHerScraper = PlanetaHerScraper;
